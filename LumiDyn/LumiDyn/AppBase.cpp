...
#pragma endregion 
	...
	void AppBase::createGraphicsPipeline() {
		auto vertShaderCode = FileUtils::readFile("shaders/base/base.vert.spv");
		auto fragShaderCode = FileUtils::readFile("shaders/base/base.frag.spv");
...
for (auto framebuffer : swapChainFramebuffers) {
	...
	void AppBase::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
#pragma region CleanUp funcion
	...
	void AppBase::cleanupImageViews() {
		for (auto imageView : swapChainImageViews) {
			vkDestroyImageView(device, imageView, nullptr);
		}

	}
	void AppBase::cleanupFrameBuffers() {
		for (auto framebuffer : swapChainFramebuffers) {
			vkDestroyFramebuffer(device, framebuffer, nullptr);
		}

	}
	void AppBase::cleanupCommandPool() {
		vkDestroyCommandPool(device, commandPool, nullptr);
	}
	void AppBase::claenupSyncObjects() {
